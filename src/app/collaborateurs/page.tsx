...
export default function Page() {
    return (
        <main>
            <CustomHead title={"Collaborateurs"} description={"Nous transformons vos idées en expériences numériques innovantes, capturant l'attention de votre public cible."} keywords={"collaborateurs, collab"}/>
            <motion.section id="intro_collab"
                ...
                <div className="flex flex-col gap-[43px]">
                    <div className="flex flex-col items-center gap-[43px]">
                        <motion.h1 initial={{opacity: 0, y: -40}} whileInView={{opacity: 1, y: 0}}
                                   transition={{duration: 1.25, delay: 0.5}} viewport={{once: true}}
                                   className="font-bold text-4xl mt-[43px]">Collaborateurs
                        </motion.h1>
                        <motion.p initial={{opacity: 0, y: 0}} whileInView={{opacity: 1, y: 0}}
                                  transition={{duration: 1.5, delay: 0.5}} viewport={{once: true}}
                                  className="text-center w-[348px]">Nous transformons vos idées en expériences
                            numériques innovantes, capturant l&apos;attention de votre public cible.
                        </motion.p>
                    </div>
                    <div className="w-full h-[118px]">
                        <div
                            className="absolute inset-0 bg-[url('/Images/decoration/banner.png')] bg-cover bg-center opacity-10 lg:hidden h-[118px] top-[200px]"></div>
                        <motion.div initial={{opacity: 0, y: 40, scale: 1}} whileInView={{opacity: 1, y: 0}}
                                    transition={{duration: 1.25, delay: 0.5}} viewport={{once: true}}
                                    className="relative flex justify-center items-center w-full h-fit">
                            <Link href="/nous-contacter"
                                  className="flex justify-center items-center w-[343px] h-[41px] bg-custom_yellow rounded-[5px] shadow-lg z-10 hover:scale-105 transition-transform">
                                Contactez-nous &rarr;
                            </Link>
                        </motion.div>
                    </div>
            ...
            <section id="collab_1"
                     className="flex flex-col items-center gap-[22px] px-[10px] py-5 relative lg:flex-row lg:h-[320px] justify-center lg:gap-52">
                ...
                <motion.div initial={{scale: 0}} whileInView={{scale: 1}} transition={{type: "spring", bounce: 0.25}}
                            viewport={{once: true}} className="flex flex-col gap-[22px] justify-center items-center">
                    <motion.p className="w-[300px] md:w-[500px] text-center">Je suis Baptiste Petit, fondateur de
                        PSDOweb, une entreprise dédiée à la mise en relation de développeurs web freelances et de
                        clients ayant des besoins technologiques spécifiques. Notre mission est de connecter des talents
                        qualifiés avec des projets ambitieux, en garantissant qualité, sécurité et originalité.
            ...
            <section id="collab_2"
                     className="flex flex-col items-center gap-[22px] px-[10px] py-5 relative lg:flex-row-reverse lg:h-[320px] justify-center lg:gap-52">
                <motion.div initial={{scale: 0}} whileInView={{scale: 1}} transition={{type: "spring", bounce: 0.25}}
                            viewport={{once: true}} className="flex flex-col gap-[10px] items-center">
                    <div className="rounded-full bg-black w-fit">
                ...
                <motion.div initial={{scale: 0}} whileInView={{scale: 1}} transition={{type: "spring", bounce: 0.25}}
                            viewport={{once: true}} className="flex flex-col gap-[22px] justify-center items-center">
                    <p className="w-[300px] md:w-[500px] text-center">En tant que développeur web expérimenté,
                        j&apos;excelle aussi bien en front-end qu&apos;en back-end, combinant une solide maîtrise
                        technique avec une grande créativité. Je suis prêt à mettre mes compétences à votre disposition
                        pour assurer le succès de votre projet.</p>
                    <motion.div initial={{scale: 1}} whileHover={{scale: 1.15}}>
                        <Link href="https://www.benjamin-desmet.com/" target={"_blank"}
                              className="flex justify-center items-center w-[343px] h-[41px] bg-custom_yellow rounded-[5px] shadow-lg z-10">
                            Portfolio
                        </Link>
                    </motion.div>
            ...
            <section id="collab_3"
                ...
                <motion.div initial={{scale: 0}} whileInView={{scale: 1}} transition={{type: "spring", bounce: 0.25}}
                            viewport={{once: true}} className="flex flex-col gap-[22px] justify-center items-center">
                    <p className="w-[300px] md:w-[500px] text-center">Passionné par le codage informatique depuis de
                        nombreuses années, j&apos;ai toujours eu une prédilection pour le développement web, tant pour
                        l&apos;aspect design que pour le côté technique. Je serais ravi de mettre mes compétences à
                        votre service pour mener à bien votre projet.</p>
                    <motion.div initial={{scale: 1}} whileHover={{scale: 1.15}}>
            ...
            <section id="collab_4"
                ...
                <motion.div initial={{scale: 0}} whileInView={{scale: 1}} transition={{type: "spring", bounce: 0.25}}
                            viewport={{once: true}} className="flex flex-col gap-[22px] justify-center items-center">
                    <p className="w-[300px] md:w-[500px] text-center">Je suis un développeur web spécialisé en front-end
            ...
            <section id="collab_5"
                     className="flex flex-col items-center gap-[22px] px-[10px] py-5 relative lg:flex-row lg:h-[320px] justify-center lg:gap-52 bg-gradient-to-t from-0% from-custom_blue_black to-10% to-white">
                <motion.div initial={{scale: 0}} whileInView={{scale: 1}} transition={{type: "spring", bounce: 0.25}}
                            viewport={{once: true}} className="flex flex-col gap-[10px] items-center">
                    <div className="rounded-full bg-black w-fit">
                ...
                <motion.div initial={{scale: 0}} whileInView={{scale: 1}} transition={{type: "spring", bounce: 0.25}}
                            viewport={{once: true}} className="flex flex-col gap-[22px] justify-center items-center">
                    <p className="w-[300px] md:w-[500px] text-center">Je suis un développeur web full stack avec une
                        expertise particulière en front-end. Ma maîtrise approfondie de l&apos;accessibilité web me
