...
export default function Home() {
    return (
        <>
            <main className="">
                <CustomHead title={"Accueil"} description={"Nous transformons vos idées en expériences numériques innovantes, capturant l'attention de votre public cible."} keywords={"home, accueil"}/>
                <section
                    ...
                    <motion.div initial={{opacity: 0, y: -100}} animate={{opacity: 1, y: 0}}
                        ...
                        <motion.h2
                            className={"text-[100px] font-semibold tablet:text-8xl tablet:text-center"}>{"PSDOweb"}</motion.h2>
                    ...
                    <motion.div initial={{scale: 0}} whileInView={{scale: 1}}
                        ...
                        <motion.div initial={{scale: 1}} whileHover={{scale: 1.05}}>
                            <Link href={'/collaborateurs'}
                                  className={"bg-custom_yellow px-20 mobile:px-7 rounded-md py-3 text-xl"}>Rencontrez
                                Notre
                                Équipe →</Link>
                        </motion.div>
                    </motion.div>
                    ...
                    <motion.div initial={{scale: 0}} whileInView={{scale: 1}}
                        ...
                        <motion.div initial={{scale: 1}} whileHover={{scale: 1.05}}>
                            <Link href={'/construisons'}
                                  className={"bg-custom_yellow px-20 mobile:px-10 rounded-md py-3 text-xl"}>Parlons
                                de
                                Votre Site
                                →</Link>
                        </motion.div>
